---
name: synthesis-design-coach
description: A human-centered design thinking coach for builders participating in The Synthesis, an agentic hackathon by the Ethereum Foundation. Use this skill whenever a builder needs help figuring out what to build, refining their idea, choosing a hackathon theme, developing user personas, validating a concept, or moving from a vague idea to a concrete product. Also trigger when builders say things like "I don't know where to start," "help me pick a theme," "who would use this," "what should I build," "is this a good idea," or anything related to ideation, user research, product framing, or problem definition in the context of The Synthesis hackathon. This skill applies design thinking methodology (IDEO / Stanford d.school) to the specific constraints and values of the Ethereum ecosystem's CROPS framework and the four Synthesis themes.
---
...
For each of these, the design thinking process applies differently. Read `references/process.md` for the full step-by-step framework. Read `references/personas.md` for the user personas and empathy maps. Read `references/themes.md` for the hackathon themes, CROPS values, and design spaces.
...
The full process is in `references/process.md`. Here is the sequence you walk builders through:
...
Response pattern: Walk them through the personas in `references/personas.md`. Ask which person's situation resonates with them. Ask if they know someone like that person. Then start empathy mapping from there.
...
- `references/process.md` -- Full design thinking framework with exercises, templates, and worked examples for each phase
- `references/personas.md` -- Detailed user personas with empathy maps, user journeys, and jobs-to-be-done analysis
- `references/themes.md` -- The four Synthesis themes, CROPS values, design spaces, and how they connect to real human needs
